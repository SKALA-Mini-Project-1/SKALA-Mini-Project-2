...
public class UserArtistFanScore {
    ...
    public void replaceBookingScore(int newBookingScore) {
        bookingScore = Math.max(0, newBookingScore);
        recomputeTotalScore();
    }

    public void addBookingScore(int delta) {
        replaceBookingScore(getBookingScoreValue() + delta);
    }

    public void replaceExternalScore(int newExternalScore) {
        externalScore = Math.max(0, newExternalScore);
        recomputeTotalScore();
    }

    public int getBookingScoreValue() {
        return bookingScore == null ? 0 : bookingScore;
    }

    public int getExternalScoreValue() {
